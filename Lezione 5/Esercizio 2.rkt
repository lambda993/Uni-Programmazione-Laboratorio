...
(define L-tessellation
  (lambda (n)
    (if (= n 1)
        L-tile
        (if (= n 2)
            (glue-tiles (glue-tiles (glue-tiles L-tile (shift-down (quarter-turn-left L-tile) 2)) (shift-down (shift-right L-tile 1) 1)) (shift-right (quarter-turn-right L-tile) 2))
            
            (glue-tiles (glue-tiles (glue-tiles (L-tessellation (/ n 2)) (shift-down (quarter-turn-left (L-tessellation (/ n 2))) n))
